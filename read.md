...
1. **Lần đầu:** màn hình hiện _"Giu BOOT 3s"_. Giữ nút **BOOT** ~3 giây để vào đăng ký.
2. **Đăng ký:** vẽ pattern (>= 4 điểm), màn hiện _"Ve lai de xac nhan"_, vẽ lại đúng như vậy,
   _"Dang luu..."_ (màn hình **đứng ~1s** do xóa Flash), rồi _"Da luu"_ và về khóa.
3. **Mở khóa:** vẽ đúng pattern thì hiện _"Mo khoa OK"_ (xanh) và tự khóa lại sau ~3s. Sai thì _"Sai, thu lai"_ (đỏ).
